...
constexpr Color SliderTrack = {18, 20, 24, 255};      // recessed groove
constexpr Color SliderFill = {92, 142, 222, 255};     // filled portion, left of the handle
constexpr Color SliderHandle = {150, 190, 244, 255};
constexpr Color SliderHandleHot = {190, 214, 250, 255};
constexpr Color ElementBorder = {70, 76, 86, 255};    // 1 px outline for inset rectangles
...
constexpr Color AudioSourceIcon = {255, 176, 48, 255};
constexpr Color ListenerIcon = {150, 210, 235, 255};
constexpr Color ListenerActive = {104, 236, 190, 255}; // the one active listener
constexpr Color IconBackdrop = {16, 18, 24, 205};      // disc behind an icon glyph
