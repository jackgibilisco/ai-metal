...
SRC_CPP := src/arena.cpp src/game.cpp src/scene_import.cpp src/blend_file.cpp src/menu.cpp src/ui.cpp
SRC_MM := src/renderer_metal.mm src/ui_render_metal.mm src/app.mm src/platform_macos.mm
